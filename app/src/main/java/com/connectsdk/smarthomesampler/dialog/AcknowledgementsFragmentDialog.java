/*
 * AcknowledgementsFragmentDialog
...
public class AcknowledgementsFragmentDialog extends DialogFragment {

    public static AcknowledgementsFragmentDialog newInstance() {
        return new AcknowledgementsFragmentDialog();
    }
